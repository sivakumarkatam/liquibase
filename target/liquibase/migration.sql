...
--  Ran at: 7/25/18 5:22 PM
--  Against: root@localhost@jdbc:mysql://localhost:3306/siva
--  Liquibase version: 3.5.3
--  *********************************************************************

--  Lock Database
UPDATE siva.DATABASECHANGELOGLOCK SET LOCKED = 1, LOCKEDBY = 'ip-10-0-1-249.ap-southeast-1.compute.internal (10.0.1.249)', LOCKGRANTED = '2018-07-25 17:22:35.895' WHERE ID = 1 AND LOCKED = 0;
